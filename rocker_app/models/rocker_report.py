...
class Report(models.Model):
    ...
    column_headings = fields.Char('Column headings', default='Report_type; Count',
    ...
    def export_ppt(self, context=None):
        ...
        if self.report_type == 'single':
            ...
            if con:
                ...
                # one per page
                slide, element_written = self._populate_pp_sql(self, con, prs, slide, page_elements, pp_title,
            ...
            for report in self.report_ids:
                ...
                if con:
                    ...
                    slide, element_written = self._populate_pp_sql(report, con, prs, slide, page_elements, pp_title,
                                                                   report.select_clause, report.column_headings,
                                                                   cnt_report, element_written, collection, report.lang)
                else:
                    raise exceptions.ValidationError('No DB connection')
                cnt_report += 1
    ...
    def _about(self, workbook, context=None):
        ...
        aboutsheet.Cells(4, 3).Value = str(fields.Datetime.context_timestamp(
            self,
            fields.Datetime.now()
        ))
    ...
    def _populate_pp_sql(self, report, con, prs, slide, page_elements, pp_title, sql, headings, cnt_report,
