{'name': 'Rocker Reporting Application',
 ...
 'description': 'Collect data to Excel workbook report from various data sources, Use templates to present business graphs. Combine data with Excel Power Pivot (Excel Pivot). Get data from Odoo & external PostgreSQL, SQLServer, MySQL, MariaDB, ODBC or Oracle databases.',
 'author': 'Antti Kärki',
 'depends': ['base','web'],
 'license': 'AGPL-3',
